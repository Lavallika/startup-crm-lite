...
export const BarChartCard = ({ data }) => {
  ...
  return (
    <div className="bg-gray-800 dark:bg-white rounded-2xl p-6 border border-gray-700 dark:border-slate-200 shadow-sm hover:shadow-md transition-all h-96 flex flex-col">
      <div className="mb-4">
        <h3 className="text-lg font-semibold text-white dark:text-slate-900">Monthly Leads Trend</h3>
        <p className="text-sm text-gray-400 dark:text-slate-500">Lead generation over the last 6 months</p>
      </div>
