  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all h-full">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Sales Velocity</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Revenue generated per day</p>
        </div>
      ...
      <div className="mt-4">
        <div className="text-3xl font-bold text-gray-900 dark:text-white">
          {formatCurrency(velocity)}<span className="text-lg text-gray-500 dark:text-gray-400 font-medium">/day</span>
        </div>
